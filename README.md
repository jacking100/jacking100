...
### 🚀 Sobre mim
- 💻 Atualmente trabalhando em projetos com **Java**, **MySQL** e **PostgreSQL**
- 📚 Estudando **Estrutura de Dados**, **Algoritmos** e **Linux**
- 🛠️ Explorando o padrão **MVC** com repositórios, entidades e controladores
- 🐳 Usando **Docker** para ambientes de desenvolvimento
- 📊 Amante de **gráficos**, **dashboards** e tudo que envolva dados!
